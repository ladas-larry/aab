...
import { occupations, taxes } from '/js/utils/constants.mjs';
import { isEastGerman } from '/js/utils/germanStates.mjs';
import { calculateUnemploymentInsurance } from '/js/utils/tax.mjs';
...
export default {
	...
	computed: {
		...
		results() {
			return calculateUnemploymentInsurance(this.yearlyIncome, this.occupation, isEastGerman(this.germanState));
		},
