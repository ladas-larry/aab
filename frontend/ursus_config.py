...
ctx["INCOME_TAX_BRACKET_2_MAX_INCOME"] = fail_on("2026-03-12", 17799)  # § 32a EstG [UPTAB26 - 1]
ctx["INCOME_TAX_BRACKET_3_MAX_INCOME"] = fail_on("2026-03-12", 69878)  # § 32a EstG [UPTAB26 - 1]
ctx["INCOME_TAX_BRACKET_4_MAX_INCOME"] = fail_on("2026-03-12", 277825)  # § 32a EstG [UPTAB26 - 1]

# Upper bound (€/y) of income tax tariff zones for tax classes 5 and 6
ctx["INCOME_TAX_CLASS_56_LIMIT_1"] = fail_on("2026-03-12", 14071)  # § 39b Abs. 2 Satz 7 EstG [W1STKL5]
ctx["INCOME_TAX_CLASS_56_LIMIT_2"] = fail_on("2026-03-12", 34939)  # § 39b Abs. 2 Satz 7 EstG [W2STKL5]
ctx["INCOME_TAX_CLASS_56_LIMIT_3"] = fail_on("2026-03-12", 222260)  # § 39b Abs. 2 Satz 7 EstG [W3STKL5]
...
ctx["SONDERAUSGABEN_PAUSCHBETRAG"] = fail_on("2026-03-12", 36)  # (€/y) § 10c EStG [SAP]
...
ctx["KINDERFREIBETRAG"] = fail_on("2026-03-12", (3414 + 1464) * 2)

# Tax break for single parents (€/y) - § 24b EStG [EFA]
ctx["ENTLASTUNGSBETRAG_ALLEINERZIEHENDE"] = fail_on("2026-03-12", 4260)
ctx["ENTLASTUNGSBETRAG_ALLEINERZIEHENDE_EXTRA_CHILD"] = fail_on("2026-03-12", 240)
...
ctx["MIDIJOB_MAX_INCOME"] = fail_on("2026-03-12", 2100)
...
ctx["EXPAT_STUDENT_COST"] = fail_on("2026-03-12", 72)  # /out/feather-expats
...
ctx["LEGAL_HOTLINE_COST_PER_MINUTE"] = fail_on("2026-03-12", 3)  # https://www.vonengelhardt.com/en/helpnowen
