...
A little over a year ago, I started collecting feedback about immigration office wait times. No one - not even the LEA - had such data. We now have over 1,000 responses for residence permits, and nearly 300 for citizenship applications. This data helps us see how long it really takes to get a residence permit, and to plan around *Ausländerbehörde* delays.
...
Last month, I have made All About Berlin's [entire source code](https://github.com/All-About-Berlin/aab) public. A few readers have already contributed changes. It was a bit of a risky move, so I'm happy that it's working out so well.
...
It's *really* hard to get an ADHD diagnosis with public health insurance. Fortunately, it's [apparently possible](https://old.reddit.com/r/berlin/comments/1r9s2y2/why_is_it_so_hard_to_get_an_adhd_diagnosis_in/o6lxvws/?context=3) to get a diagnosis from a private psychiatrist. You might need to pay out of pocket, but it dramatically speeds things up. Once you have the diagnosis, your insurer will cover the medication.
