...
You don't need to speak German to move to Berlin, but [it's *very* useful](/guides/learn-german#do-i-need-to-speak-german-in-berlin). You always need to write emails, read letters and make phone calls in German. If you don't speak German, you always depend on someone else to help you. If you speak German, it's easier to [find an apartment](/guides/find-a-flat-in-berlin), [find a job](/guides/find-a-job-in-berlin) and [make friends](/guides/making-friends).
...
- learn [how to sort your trash](/guides/sorting-trash-in-germany) and [return empty bottles](/guides/pfand-bottles)
- learn [how to safely stream movies and shows](/guides/pirating-streaming-movies-in-germany)
- respect the [quiet hours](/guides/quiet-hours)
- remember that [most businesses close on Sundays](/guides/open-on-sundays-in-berlin)
- [make a budget](/guides/cost-of-living) and find ways to [save money](/guides/saving-money-germany)
- understand [how German phone numbers work](/guides/dial-phone-numbers-germany)
