...
{% calculator "healthInsurance", occupation="azubi", static=True %}
...
**If you earn more than €{{GKV_AZUBI_FREIBETRAG|cur}} per month**, you can only choose [public health insurance](/glossary/gesetzliche%20Krankenversicherung).[^4] It costs {{GKV_MIN_RATE_EMPLOYEE}}% to {{GKV_MAX_RATE_EMPLOYEE}}% of your income (including *[[Pflegeversicherung]]*).[^2] You can't get [free health insurance](/guides/german-health-insurance#free-health-insurance).[^3]
