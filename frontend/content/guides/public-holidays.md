...
{% with year = 2026 %}{% include "_blocks/publicHolidays.html" %}{% endwith %}

## 2027 public holidays in Berlin

{% with year = 2027 %}{% include "_blocks/publicHolidays.html"%}{% endwith %}

## 2028 public holidays in Berlin

{% with year = 2028 %}{% include "_blocks/publicHolidays.html"%}{% endwith %}

## Add public holidays to your calendar

- [Instructions for Google Calendar](https://support.google.com/calendar/answer/6084659?hl=en&ref_topic=10510242)
...
**If you were not supposed to work**, you don't get paid. For example, if you only work on Mondays and Fridays, and the public holiday is on a Tuesday, you don't get paid.[^2] If you work part-time, and you don't have a fixed schedule, public holidays are rarely paid.[^3]

**If you work in another state**, you celebrate the holidays of the state where you work.[^0] For example, if you live in Brandenburg, and you work in Berlin, you get a paid day off when it's a public holiday in Berlin.

**If you are on vacation** during a public holiday, you still get a free day off. You don't need to use a vacation day.[^4] For example, if you are on vacation for 5 days, and 1 day is a public holiday, you only use 4 vacation days.
